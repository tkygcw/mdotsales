    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: Container(
            ...
            padding:
                compressedFileSource != null ? const EdgeInsets.only(left: 20, right: 20) : const EdgeInsets.only(left: 20, right: 20, bottom: 350),
            decoration: const BoxDecoration(image: DecorationImage(fit: BoxFit.fill, image: AssetImage("assets/addtask.jpg"))),
            child: Column(
